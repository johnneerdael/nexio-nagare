#!/usr/bin/env node
//===============
// Identity map refresh CLI.
// Usage:
//   node scripts/identity-refresh.js
//   node scripts/identity-refresh.js --map data/anime/nexio-anime-map-v1.json
//   node scripts/identity-refresh.js --fribb-file ./fribb.json --scudlee-file ./scudlee.xml
// Exit code 0 on success (or if usedExisting fallback succeeds), 1 otherwise.
//===============
...
function fileSourceFetcher(args) {
    ...
    return async () => ({
        fribb: { url: args.fribbFile, commit: null, text: fs.readFileSync(args.fribbFile, "utf8") },
        scudlee: { url: args.scudleeFile, commit: null, text: fs.readFileSync(args.scudleeFile, "utf8") }
    });
}
